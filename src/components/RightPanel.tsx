...
import { useGitHubCommitFlow } from './rightPanel/useGitHubCommitFlow'
import {
  parseNumberInput,
  parseSelectedNode,
...
export function RightPanel() {
  ...
  return (
    ...
    >
        ...
        {!glyph ? (
          ...
          <Stack spacing={4}>
            ...
            <ProjectSaveCard
              ...
              onOpenGitHubModal={() => void gitHubCommitFlow.openGitHubModal()}
      ...
      <GitHubCommitModal {...gitHubCommitFlow.modalProps} />
    </Box>
  )
}
